...
const translations = {
  cs: {
    ...
    tours_desc: "Naplánujte si dovolenou s MaxiSky. Díky partnerství s Invia porovnáte zájezdy a last minute od více než 120 cestovních kanceláří na jednom místě – za stejné ceny jako přímo u CK.",
    tours_brand_sub: "Zájezdy a last minute od 120+ CK",
    tours_why_title: "Proč zájezdy přes MaxiSky",
    tours_b1: "Jedno místo pro letenky, ubytování i celé dovolené",
    tours_b2: "Porovnání více než 120 cestovních kanceláří – vždy nejlepší cena",
    tours_b3: "Stejné ceny jako u cestovní kanceláře, žádné poplatky navíc",
  ...
  sk: {
    ...
    tours_desc: "Naplánujte si dovolenku s MaxiSky. Vďaka partnerstvu s Invia porovnáte zájazdy a last minute od viac než 120 cestovných kancelárií na jednom mieste – za rovnaké ceny ako priamo u CK.",
    tours_brand_sub: "Zájazdy a last minute od 120+ CK",
    tours_why_title: "Prečo zájazdy cez MaxiSky",
    tours_b1: "Jedno miesto pre letenky, ubytovanie aj celé dovolenky",
    tours_b2: "Porovnanie viac než 120 cestovných kancelárií – vždy najlepšia cena",
    tours_b3: "Rovnaké ceny ako u cestovnej kancelárie, žiadne poplatky navyše",
  ...
  en: {
    ...
    tours_desc: "Plan your holiday with MaxiSky. Thanks to our Invia partnership, compare tours and last-minute deals from 120+ travel agencies in one place – at the same prices as the agency.",
    tours_brand_sub: "Tours & last minute from 120+ agencies",
    tours_why_title: "Why book tours via MaxiSky",
    tours_b1: "Flights, stays and full holidays in one place",
