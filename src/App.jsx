...
const translations = {
  cs: {
    ...
    tours_desc: "Vyberte si dovolenou snů z nabídky více než 120 cestovních kanceláří – přehledně na jednom místě. Last minute, first minute i exotika za stejné ceny jako přímo u cestovky. Stačí zadat termín a hledat.",
    tours_brand_sub: "Zájezdy a last minute od 120+ CK",
    tours_why_title: "Proč rezervovat přes MaxiSky",
    tours_b1: "Letenky, ubytování i celé dovolené na jednom místě",
  ...
  sk: {
    ...
    tours_desc: "Vyberte si dovolenku snov z ponuky viac než 120 cestovných kancelárií – prehľadne na jednom mieste. Last minute, first minute aj exotika za rovnaké ceny ako priamo u cestovky. Stačí zadať termín a hľadať.",
    tours_brand_sub: "Zájazdy a last minute od 120+ CK",
    tours_why_title: "Prečo rezervovať cez MaxiSky",
    tours_b1: "Letenky, ubytovanie aj celé dovolenky na jednom mieste",
  ...
  en: {
    ...
    tours_desc: "Pick your dream holiday from 120+ travel agencies – all in one place. Last minute, first minute and exotic trips at the same prices as the agency. Just set your dates and search.",
    tours_brand_sub: "Tours & last minute from 120+ agencies",
    tours_why_title: "Why book with MaxiSky",
